...
function myLogPassword(){
    let password_input_field = document.querySelector('.box-container .box .box-login .input-group-div .input-field #logPassword');
    let password_input_field_eye = document.querySelector('.box-container .box .box-login .input-group-div .input-field .eye-area .eye-box img:nth-child(1)');
    let password_input_field_eye_slash = document.querySelector('.box-container .box .box-login .input-group-div .input-field .eye-area .eye-box img:nth-child(2)');
