<?php
    ...
    if(!$connect){
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            $cpass = $_POST['cpass'];
            if($pass == $cpass){
                $passhash = password_hash($pass, PASSWORD_DEFAULT, ['cost' => 15]);
                ...
                if($result){
                    ...
                    <strong>Account created successfully.</strong> Please login to Enjoy our security service.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
                else{
...
<html lang="en">
  ...
  <body style="padding:5px;">
    ...
    <form style="padding:20px;" action="/phpweb/loginSystem/signup.php" method="post">
  <div class="mb-3">
